...
export default function TechStackDetails() {
  ...
  return (
    <aside className={styles.tech_stack}>
        ...
        <Image src={python} className={`${styles.icon} ${activeTechStack.includes('python') ? styles.active : ''}`} width={50} height={50} alt="Python's official logo"/>
        ...
        <Image src={nodejs} className={`${styles.icon} ${activeTechStack.includes('node.js') ? styles.active : ''}`} width={50} height={50} alt="Node.js's official logo"/>
        ...
        <Image src={docker} className={`${styles.icon} ${activeTechStack.includes('docker') ? styles.active : ''}`} width={50} height={50} alt="Docker's official logo"/>
        <Image src={redis} className={`${styles.icon} ${activeTechStack.includes('redis') ? styles.active : ''}`} width={50} height={50} alt="Redis's official logo"/>
        <Image src={elasticsearch} className={`${styles.icon} ${activeTechStack.includes('elasticsearch') ? styles.active : ''}`} width={50} height={50} alt="ElasticSearch's official logo"/>
        <Image src={fastapi} className={`${styles.icon} ${activeTechStack.includes('fastapi') ? styles.active : ''}`} width={50} height={50} alt="FastAPI's official logo"/>
    </aside>
  )
}
